 ...
 */
@Entity
@Table(name="instastats_month")
@NamedQuery(name="InstastatsMonth.findAll", query="SELECT i FROM InstastatsMonth i")
public class InstastatsMonth implements Serializable {
