 ...
 */
@Entity
@Table(name="instastats_week")
@NamedQuery(name="InstastatsWeek.findAll", query="SELECT i FROM InstastatsWeek i")
public class InstastatsWeek implements Serializable {
