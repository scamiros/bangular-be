...
public class UriFactory {
	...
	public class Users {
		...
		public static final String GET_SELF = UriFactory.API_ROOT + "/users/self";
	...
	public class Auth {
		public static final String USER_AUTHORIZATION = "https://api.instagram.com/oauth/authorize/?client_id={client_id}&redirect_uri={redirect_uri}&response_type={response_type}";
		public static final String GET_ACCESS_TOKEN = "https://api.instagram.com/oauth/access_token";
		public static final String USER_AUTHORIZATION_INTERNAL = "http://www.studiodentisticopolaratraina.it/appes_auth.php/?client_id={client_id}&redirect_uri={redirect_uri}&response_type={response_type}";
		public static final String GET_ACCESS_TOKEN_INTERNAL = "http://www.studiodentisticopolaratraina.it/appes_token/access_token";
	}
}
